...
//        cacheManager.createCache("categoryList", new MutableConfiguration<>().setExpiryPolicyFactory(TouchedExpiryPolicy.factoryOf(new Duration(TimeUnit.SECONDS, 20))).setStoreByValue(false).setStatisticsEnabled(false));
