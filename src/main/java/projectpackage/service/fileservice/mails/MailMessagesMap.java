...
public class MailMessagesMap {
...

    {
        ...
        messages.put(1, new MailDataHolder("Booked room", "You have registered order for a room at NCHotel. Please, pay for your order(order data is attached by a file) and dwait for administration of our hotel to contact you."));
        messages.put(2, new MailDataHolder("Payment confirmation", "Thank you for your payment."));
        messages.put(3, new MailDataHolder("Statistic", "Statistic for current date."));
