...
public class DRTest {
    ...
    public void doTestReader(){
        ...
        reader.getClasses();
        Map<Class, Map<String, EntityVariablesData>> objectVariables = reader.makeObjectsVariablesMap();
        Map<Class, Map<Class, EntityOuterRelationshipsData>> outerRelations = reader.makeOuterRelationshipsMap();
        Map<Class, Map<Class, EntityReferenceRelationshipsData>> referenceRelations = reader.makeObjectsReferenceRelationsMap();
        System.out.println("CLASSES:");
        reader.printClassesList();
        System.out.println();
        System.out.println("VARIABLES:");
        for (Map.Entry<Class, Map<String, EntityVariablesData>> entry: objectVariables.entrySet()){
        ...
        for (Map.Entry<Class, Map<Class, EntityOuterRelationshipsData>> entry: outerRelations.entrySet()){
        ...
        for (Map.Entry<Class, Map<Class, EntityReferenceRelationshipsData>> entry: referenceRelations.entrySet()){
            System.out.println("INNER CLASS KEY="+entry.getKey());
